  ...
  return (
    <div className='relative w-full'>
      <input
        ...
        placeholder=' '
        className={cn(
          'peer bg-transparent file:text-foreground placeholder:text-muted-foreground selection:bg-primary rounded-2xl selection:text-primary-foreground dark:bg-input/30 border-neutral-800 h-12 w-full min-w-0 border text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
          'focus-visible:border-neutral-500 focus-visible:ring-neutral-500/50 focus-visible:ring-[3px]',
      ...
      {icon && (
        <button
          ...
          tabIndex={-1}
          className={cn(
            'absolute inset-y-0 h-full text-neutral-500',
