"use client";
import { FlexibleImage, Hero, SectionWrapper, ShowOrSkeleton } from "@/components/container";
        ...
        <Hero>
          ...
          <Hero.Content className="mt-[-100] lg:mt-[-210px]">
            <div className="flex flex-row gap-4 lg:gap-6 ">
              ...
              <div className="space-y-2 lg:flex lg:flex-col gap-5 flex-1">
                ...
                <HeroAction
                  ...
                  onWatchTrailer={() => push(`/movies/trailer/${id}`)}
            ...
            <HeroAction
              ...
              onWatchTrailer={() => push(`/movies/trailer/${id}`)}
            />
            <ItemsCardMapping rating={vote_average} genres={genres} adult={adult} />
          </Hero.Content>
        </Hero>
      </ShowOrSkeleton>
      <ShowOrSkeleton isLoading={isLoading} skeleton={<OverviewDetailSkeleton />}>
        <SectionWrapper>
              ...
              <CreditsCard key={crew.credit_id} className="">
                ...
                <CreditsCard.Info>
                  <TypographyTitle
                    ...
                    className="font-semibold"
                  />
                  <TypographySub label={crew.job} size="sm" lgSize="md" className="font-normal" />
                </CreditsCard.Info>
              </CreditsCard>
            ))}
          </div>
